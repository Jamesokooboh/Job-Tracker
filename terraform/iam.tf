...
# Scoped narrowly: execution role can read ONLY this app's secret, nothing else.
...
# This app doesn't call any other AWS APIs, so it stays empty/minimal --
# resist the temptation to attach broad permissions "just in case."
